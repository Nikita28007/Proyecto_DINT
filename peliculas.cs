...
namespace Proyecto_DINT
{
    class Peliculas : INotifyPropertyChanged
    {
        ...
        public static List<Peliculas> listaPeliculas()
        {
            ...
            Peliculas peli3 = new Peliculas("https://image.tmdb.org/t/p/original/kKTPv9LKKs5L3oO1y5FNObxAPWI.jpg", "Erase una vez en holywood", "victima: Sharon tate", "dificil", "Comedia/Comedia dramática");
